...
public record ActiveJobProposal(
	...
	public ActiveJobProposal(
		...
		this(type, targetPlayer, position, mineSpec, taskSpec, craftRecipe, dropItems, null, null, null, askPrompt);
	}
	...
	public ActiveJobProposal(
		...
		this(type, targetPlayer, position, mineSpec, taskSpec, craftRecipe, dropItems, entityInteraction, null, null, askPrompt);
	}
	...
	public static ActiveJobProposal followPlayer(String targetPlayer) {
		return new ActiveJobProposal(ActiveJobType.FOLLOW_PLAYER, targetPlayer, null, null, null, null, null, null, null, null, null);
	}

	public static ActiveJobProposal navigateTo(GoalPosition position) {
		return new ActiveJobProposal(ActiveJobType.NAVIGATE_TO, null, position, null, null, null, null, null, null, null, null);
	}
	...
	public static ActiveJobProposal craftRecipe(CraftRecipeStepArgs craftRecipe) {
		return new ActiveJobProposal(ActiveJobType.CRAFT_RECIPE, null, null, null, null, craftRecipe, null, null, null, null, null);
	}

	public static ActiveJobProposal dropItems(DropItemsStepArgs dropItems) {
		return new ActiveJobProposal(ActiveJobType.DROP_ITEMS, null, null, null, null, null, dropItems, null, null, null, null);
	}

	public static ActiveJobProposal smeltItems(SmeltItemsStepArgs smeltItems) {
		return new ActiveJobProposal(ActiveJobType.SMELT_ITEMS, null, null, null, null, null, null, null, smeltItems, null, null);
	}

	public static ActiveJobProposal collectSmeltedItems(CollectSmeltedItemsStepArgs collectSmeltedItems) {
		return new ActiveJobProposal(ActiveJobType.COLLECT_SMELTED_ITEMS, null, null, null, null, null, null, null, null, collectSmeltedItems, null);
	}

	public static ActiveJobProposal attackEntity(EntityInteractionStepArgs entityInteraction) {
		return new ActiveJobProposal(ActiveJobType.ATTACK_ENTITY, null, null, null, null, null, null, entityInteraction, null, null, null);
	}

	public static ActiveJobProposal useEntity(EntityInteractionStepArgs entityInteraction) {
		return new ActiveJobProposal(ActiveJobType.USE_ENTITY, null, null, null, null, null, null, entityInteraction, null, null, null);
	}

	public static ActiveJobProposal askUser(String askPrompt) {
		return new ActiveJobProposal(ActiveJobType.ASK_USER, null, null, null, null, null, null, null, null, null, askPrompt);
	}
}
