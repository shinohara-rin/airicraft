...
class FootingMemoryTest {
	...
	@Test void straddlingAnExcavationProtectsTheObservedEdgeInsteadOfAirUnderTheCenter() {
		var known = Map.of(CENTER, new Seen("minecraft:air", true, true, 12, 2), EDGE, new Seen("minecraft:stone", false, true, 12, 2));
	...
	@Test void missingObservationDoesNotEraseARememberedSupportOrInventANewOne() {
		...
		assertEquals(Set.of(), FootingMemory.update(Set.of(CENTER), Map.of(CENTER, new Seen("minecraft:air", true, true, 12, 2)), Optional.empty()));
	}
}
