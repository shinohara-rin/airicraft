...
class ObservedReachTest {
	@Test void unknownAndOccupiedCellsBlockReachEvenWhenTheTargetIsRemembered() {
		...
		for (int z = 0; z < 3; z++) known.put(new Pos(0, 1, z), new Seen("air", true, true, 15, 0));
		known.put(target, new Seen("stone", false, true, 15, 0));
		...
		known.put(new Pos(0, 1, 1), new Seen("stone", false, true, 15, 0));
		assertFalse(ObservedReach.visible(known, eye, target, 4.3));
	}
}
